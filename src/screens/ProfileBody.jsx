    ...
    <>
      <div className="k-prof">
        ...
        <div className="k-level">
          ...
          {isMe && <span className="k-level-xp">{level.xp} XP{level.next ? ` · ${level.xpToNext} till ${level.next.title}` : " · Högsta nivån"}</span>}
          {isMe && <span className="k-level-bar"><span style={{ width: `${level.progress * 100}%` }} /></span>}
        </div>
